...
function Shares({name}){
    ...
    const [filter_div, setFilter_div] = useState('');
    ...
    React.useEffect(() => {
        ...
        data.append('filter_div', filter_div);

        const fetchData = async () => {
            try {
                const response = await axios.get(`http://localhost:8081/get_shares`, {
                    params: data,
                    headers: {
    ...
    return (
        <div>
            ...
            <div className="container">
                ...
                <FilterHandler setFilter_currency = {setFilter_currency} setFilter_country = {setFilter_country} setFilter_div = {setFilter_div} />
                ...
                <div>
                    {data ?
                        ...
                        <Link className="text-decoration-none text-reset" state={{price_units: item.price_units,
                            price_nano: item.price_nano, currency: item.currency,
